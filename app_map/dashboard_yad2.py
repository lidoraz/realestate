...
from app_map.utils import create_tooltip, get_icon, js_draw_icon, build_sidebar, preprocess_to_str_deals, \
    js_draw_icon_div, get_geojsons, get_similar_deals, get_asset_points
...
def show_assets(price_from, price_to, median_price_pct, discount_price_pct, date_added, date_updated,
